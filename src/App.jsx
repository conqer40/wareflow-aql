...
const navGroups = [
  ...
  { title: "الرقابة", items: [
    ...
    { id: "approvals", label: "الاعتمادات", icon: ShieldCheck, badge: 12 }, { id: "treasury", label: "يوميات الخزنة", icon: FileText },
